...
Instead of creating a symlink, create a SHORT `CLAUDE.md` file that explains why we use
AGENTS.md:
...
**Why AGENTS.md**: It's a vendor-neutral standard (from OpenAI, July 2025) that works
across Claude Code, Cursor, GitHub Copilot, and other AI coding assistants. Contributors
can use different tools while sharing the same context.
...
This educates about the standard while adding minimal tokens (~150) compared to
